  ...
  [
    {
      ...
      mainQuest: [
        ...
        },
        {
          sequence: 2,
          mission: [
            "Damas : Assassinat de Tamir"
          ]
        },
        {
          sequence: 3,
          mission: [
            "Acre : Assassinat de Garnier de Naplouse"
          ]
        },
        {
          sequence: 4,
          mission: [
            "Jérusalem : Assassinat de Talal"
          ]
        },
        {
          sequence: 5,
          mission: [
            "Damas : Assassinat d'Abu'l Nuqoud"
          ]
        },
        {
          sequence: 6,
          mission: [
            "Acre : Assassinat de Guillaume de Montferrat"
          ]
        },
        {
          sequence: 7,
          mission: [
            "Jérusalem : Assassinat de Majd Addin"
          ]
        },
        {
          sequence: 8,
          mission: [
            "Damas : Assassinat de Jubair al Hakim"
          ]
        },
        {
          sequence: 9,
          mission: [
            "Acre : Assassinat de Sibrand"
          ]
        },
        {
          sequence: 10,
    ...
    },
    {
      ...
      mainQuest: [
        ...
        },
        {
          ...
          mission: [
            "Le Livre Noir",
            "Enquête sur les Byzantins"
          ]
        },
        {
          sequence: 4,
          mission: [
            "La bataille du Grand Bazar",
            "L'ombre de l'ennemi"
          ]
        },
        {
    ...
    },
    {
      ...
      mainQuest: [
        ...
        },
        {
          ...
          mission: [
            "La Conspiration",
            "Affrontement avec Lee"
          ]
        },
        {
          sequence: 6,
          mission: [
            "Le siège de New York",
            "Le destin de Connor"
          ]
        },
        {
          sequence: 7,
          mission: [
            "Epilogue : L'héritage des Assassins"
          ]
        }
      ],
      sideQuest: {
      ...
      mainQuest: [
        ...
        },
        {
          ...
          mission: [
            "La Main de l'Empire",
            "La Chute du Baron",
            "Le Cœur de la Rébellion"
          ]
        },
        {
          sequence: 5,
          mission: [
            "Révolte dans les Rues",
            "La Fin d'un Dynastie",
